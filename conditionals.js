...
// ==========================================
const notTheSame = 10!==11;
console.log('10 ongelijk aan 11?', notTheSame);

// ==========================================
// 3. Declareer een variabele en sla daar in op of de woorden 'zoet' en 'sappig' hetzelfde zijn                // geeft false wanneer gelogd
// ==========================================
const theSameWords = "zoet" === "sappig";
console.log("Zijn de woorden 'zoet' en 'sappig' hetzelfde?",theSameWords);
...
if(!isRaining && temperature > 21){
    ...
    console.log("Lange kleren is prima!");
}
